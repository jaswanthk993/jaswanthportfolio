...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center pt-20 pb-16">
      <div className="container mx-auto px-4 bg-navy-DEFAULT">
        ...
        <div className="mt-16 flex justify-center">
          <button onClick={scrollToProjects} className="flex flex-col items-center text-foreground/70 hover:text-primary transition-colors">
